...
export default function FoodDetails({ foods }) {
            ...
            <div>
                <div className=" bg-white border border-gray-200 rounded-lg shadow dark:bg-gray-800 dark:border-gray-700">
                    ...
                    <div className="p-5">
                        ...
                        <p className={`mb-3 font-semibold text-lg text-gray-700 ${foodStatus === "Available" ? "text-green-500" : ""} ${foodStatus === "Pending Pickup" ? "text-blue-600" : ""} ${foodStatus === "Expired" ? "text-[#e96666]" : ""} inline rounded-full`}>{foodStatus}</p>
